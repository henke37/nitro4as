package Nitro.SDAT.SeqPlayer {
	...
	/** Various translation tables and functions */
	public class Tables {
		...
		private static const sustainTable:Vector.<uint>=new <uint> [
		...
		private static const attackTable:Vector.<uint>=new <uint> [
		...
		{
			volTable.fixed=true;
			soundSinTable.fixed=true;
			pitchTable.fixed=true;
			sustainTable.fixed=true;
			attackTable.fixed=true;
		}
		
		

		public function Tables() {
			throw new Error("Tables is a static support class, you do not instantiate it!");
		}
