package Nitro.Graphics {
	...
	/** A collection of OAMs that when renderd together composes a single picture */
	...
	public class Cell {
		...
		/** Draws a rectangle for each oam in the cell
		...
		@return A DisplayObject with the boxes representing the oams*/
